...
TARGET_KERNEL_CROSS_COMPILE_PREFIX := 4.10-linaro
...
FEATURE_CAMERA_CAPABILITY_MANUAL_SENSOR := true
FEATURE_CAMERA_CAPABILITY_MANUAL_POST_PROCESSING := true
FEATURE_CAMERA_CAPABILITY_RAW := true
